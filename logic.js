...
function myfunc() {
    ...
    if ((box1 == 'x' || box1 == 'X') && (box2 == 'x' ||
        ...
        $.notifyBar({cssClass: "success",html:'Player x won',});
    ...
    // not and after that disabled all the other fields
        ...
        $.notifyBar({cssClass: "success",html:'Player 0 won',});
    ...
    // Here, Checking about Tie
        ...
        box8 == '0') && (box9 == 'X' || box9 == '0')) {
            document.getElementById('print')
                .innerHTML = "Match Tie";
                $.notifyBar({cssClass: "error",html:'match tie',});
    }
    else {
        ...
        if (flag == 1) {
            ...
            document.getElementById('reset').style.marginTop="470px";
        }
        else if(flag == 0){
